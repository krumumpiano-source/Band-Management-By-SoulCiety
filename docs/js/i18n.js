...
(function(global){
  ...
  const i18n = {
    th: {
      ...
      upcomingJobs: 'งานที่กำลังจะมาถึง', viewAll: 'ดูทั้งหมด', financeThisMonth: 'การเงินเดือนนี้', quickActions: 'ทางลัด',
    ...
    en: {
      ...
      upcomingJobs: 'Upcoming Jobs', viewAll: 'View All', financeThisMonth: 'Finance This Month', quickActions: 'Quick Actions',
