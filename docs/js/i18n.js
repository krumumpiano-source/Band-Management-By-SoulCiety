...
(function(global){
  ...
  const i18n = {
    th: {
      ...
      inviteCode: 'รหัสเชิญ (ถ้ามี)', enterInviteCode: 'ไม่บังคับ',
      ...
      nav_dashboard: 'แดชบอร์ด', nav_songs: 'คลังเพลง & ลิสเพลง', nav_checkIn: 'ลงเวลาเข้างาน', nav_attendance: 'เบิกจ่าย (ผู้จัดการ)',
      nav_externalPayout: 'เบิกจ่ายงานนอก', nav_schedule: 'ตารางงาน', nav_jobCalculator: 'คำนวณงานนอก',
      ...
      songs_title: 'คลังเพลง & ลิสเพลง', songs_subtitle: 'เลือกเพลงจากคลัง สร้างลิส คัดลอกหรือบันทึกเป็นรูป',
    ...
    en: {
      ...
      inviteCode: 'Invite Code (optional)', enterInviteCode: 'Optional',
      ...
      nav_dashboard: 'Dashboard', nav_songs: 'Songs & Setlist', nav_checkIn: 'Check In', nav_attendance: 'Payroll (Manager)',
